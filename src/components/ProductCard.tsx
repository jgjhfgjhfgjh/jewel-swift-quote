      ...
      <div className="relative aspect-square overflow-hidden bg-muted">
        {!imgError ? (
          <img
            ...
            alt={product.name}
            loading="lazy"
            className="h-full w-full object-contain p-4 transition-transform duration-300 group-hover:scale-105 bg-neutral-50 font-mono border-slate-700 border-2 border-solid"
