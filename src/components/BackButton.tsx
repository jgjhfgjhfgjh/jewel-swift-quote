...
export function BackButton() {
  ...
  return (
    <button
      onClick={() => navigate(-1)}
      aria-label="Zpět"
      className="fixed top-[112px] left-4 z-[99] flex h-10 w-10 items-center justify-center rounded-full border border-white/30 transition-all duration-200 hover:scale-110 hover:border-white/50"
      style={{
