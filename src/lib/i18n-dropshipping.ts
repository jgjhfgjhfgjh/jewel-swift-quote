...
const cs: DropText = {
  ...
  shopUpsell: {
    ...
    h1: 'Věz, co se bude prodávat.', h1Highlight: 'swelt.signal ti to řekne předem.',
    sub: 'swelt.signal je product intelligence pro tvůj sortiment — týdenní digest trendů z celého katalogu 3 000+ produktů a AI doporučení, co přidat, co stáhnout a kdy. Součást dropshipping plánů Silver a Gold.',
    features: [
      { title: 'Trendová data každý týden', text: 'Vidíš, co roste a co klesá napříč celým katalogem.' },
      { title: 'Signály z celé EU', text: 'Prodejní data z 15+ evropských trhů, ne jen z toho tvého.' },
      { title: 'AI doporučení sortimentu', text: 'Konkrétní tipy: co přidat, co stáhnout a kdy — bez hádání.' },
      { title: 'Upozornění na příležitosti', text: 'Cenové poklesy, closeouty a nové kolekce se dozvíš první.' },
    ],
    cta1: 'Vyzkoušet dropshipping', cta2: '',
...
const en: DropText = {
  ...
  shopUpsell: {
    ...
    h1: 'Know what will sell.', h1Highlight: 'swelt.signal tells you ahead of time.',
    sub: 'swelt.signal is product intelligence for your assortment — a weekly trend digest across the whole 3,000+ product catalog with AI recommendations on what to add, what to drop and when. Included in the Silver and Gold dropshipping plans.',
    features: [
      ...
      { title: 'AI assortment recommendations', text: 'Concrete tips: what to add, what to drop and when — no guessing.' },
      { title: 'Opportunity alerts', text: 'Price drops, closeouts and new collections — you hear it first.' },
    ],
    cta1: 'Try dropshipping', cta2: '',
