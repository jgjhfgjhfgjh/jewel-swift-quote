...
const cs: AuthText = {
  ...
  loginAsB2B: 'Přihlásit jako B2B partner', separatorText: 'nebo přihlášení emailem',
...
const sk: AuthText = {
  ...
  emailLabel: 'Email', passwordLabel: 'Heslo',
  loginAsB2B: 'Prihlásiť ako B2B partner', separatorText: 'alebo prihlásenie e-mailom',
...
const pl: AuthText = {
  ...
  loginAsB2B: 'Zaloguj jako partner B2B', separatorText: 'lub logowanie e-mailem',
...
const de: AuthText = {
  ...
  loginAsB2B: 'Als B2B-Partner anmelden', separatorText: 'oder Anmeldung per E-Mail',
...
const en: AuthText = {
  ...
  loginAsB2B: 'Sign in as B2B partner', separatorText: 'or email login',
...
const fr: AuthText = {
  ...
  loginAsB2B: 'Se connecter en tant que partenaire B2B', separatorText: 'ou connexion par e-mail',
...
const es: AuthText = {
  ...
  loginAsB2B: 'Acceder como socio B2B', separatorText: 'o inicio de sesión por correo',
