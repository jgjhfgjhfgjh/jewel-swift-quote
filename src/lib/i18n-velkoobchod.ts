...
const cs: VelkoobchodText = {
  hero: {
    ...
    sub: '15 000+ produktů, 65+ světových značek, marže 40–65 %. Žádní prostředníci, žádné zbytečné přirážky. Registrace zdarma — schválení do 24 hodin.',
  ...
  preview: {
    ...
    p2: 'Uvidíte celý sortiment: 15 000+ produktů, fotky, dostupnost v reálném čase a doporučené maloobchodní ceny (MOC). Takže si rovnou spočítáte, jaké marže vás čekají.',
  ...
  steps: [
    ...
    { title: 'Nakupujte a vydělávejte', desc: 'Prohlédněte si 15 000+ produktů, zadejte objednávku, my se postaráme o expedici do 24–48 hodin.' },
  ],
  catalog: {
    eyebrow: 'Katalog',
    heading: 'Co najdete v B2B katalogu',
    sub: 'Přímý přístup k 15 000+ prémiovým hodinkám a šperkům, 8 000+ položek ihned skladem — vše s aktuálními velkoobchodními cenami a přesným přehledem zásob.',
    brandsLabel: '65+ značek dostupných od prvního kusu', brandsMore: '+40 dalších →',
  },
  features: [
    { label: '15 000+ produktů', desc: 'Hodinky, šperky, příslušenství' },
    { label: '65+ světových značek', desc: 'Tommy Hilfiger, Versace, Seiko…' },
  ...
  ecosystemItems: [
    { name: 'swelt.feed', desc: 'Automatický XML/CSV feed 15 000+ produktů. Synchronizujte katalog s vaším e-shopem bez jakékoliv manuální práce.' },
  ...
  finalCta: {
    ...
    bottomSub: 'Registrace zdarma. Schválení do 24 hodin. Přístup k 15 000+ produktům s marží 40–65 %.',
  ...
  whySwelt: {
    ...
    bullets: ['Přímé partnerství s 65+ světovými značkami', 'Garance originality — 100 % autentické produkty', 'Evropský sklad — expedice do 24–48 hodin', 'Certifikovaný záruční a pozáruční servis', 'GDPR compliance a transparentní obchodní podmínky'],
  },
...
const en: VelkoobchodText = {
  hero: {
    ...
    sub: '15,000+ products, 65+ world brands, margins 40–65 %. No middlemen, no extra markups. Free registration — approval within 24 hours.',
  ...
  preview: {
    ...
    p2: 'You will see the entire range: 15,000+ products, photos, real-time stock and recommended retail prices (RRP). So you can immediately calculate the margins you can expect.',
  ...
  steps: [
    ...
    { title: 'Buy and earn', desc: 'Browse 15,000+ products, place an order, and we will handle dispatch within 24–48 hours.' },
  ],
  catalog: {
    eyebrow: 'Catalog',
    heading: 'What you will find in the B2B catalog',
    sub: 'Direct access to 15,000+ premium watches and jewelry, 8,000+ items in stock right now — with current wholesale prices and accurate stock visibility.',
    brandsLabel: '65+ brands available from the first piece', brandsMore: '+40 more →',
  },
  features: [
    { label: '15,000+ products', desc: 'Watches, jewelry, accessories' },
    { label: '65+ world brands', desc: 'Tommy Hilfiger, Versace, Seiko…' },
  ...
  ecosystemItems: [
    { name: 'swelt.feed', desc: 'Automatic XML/CSV feed of 15,000+ products. Sync your shop with no manual work.' },
  ...
  finalCta: {
    ...
    bottomSub: 'Free registration. Approval in 24 hours. Access to 15,000+ products with 40–65 % margins.',
  ...
  whySwelt: {
    ...
    bullets: ['Direct partnership with 65+ world brands', 'Originality guarantee — 100 % authentic products', 'European warehouse — dispatch in 24–48 hours', 'Certified warranty and post-warranty service', 'GDPR compliance and transparent terms'],
  },
