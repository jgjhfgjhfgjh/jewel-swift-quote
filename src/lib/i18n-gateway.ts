...
const cs: GatewayText = {
  ...
  dropshipping: {
    badge: 'Nákupy bez registrace', label: 'Nákupy bez registrace',
...
const sk: GatewayText = {
  ...
  dropshipping: { badge: 'Nákupy bez registrácie', label: 'Nákupy bez registrácie',
...
const en: GatewayText = {
  ...
  dropshipping: { badge: 'Purchases without registration', label: 'Purchases without registration',
...
const de: GatewayText = {
  ...
  dropshipping: { badge: 'Käufe ohne Registrierung', label: 'Käufe ohne Registrierung',
