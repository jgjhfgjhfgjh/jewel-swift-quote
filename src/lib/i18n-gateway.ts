...
const cs: GatewayText = {
  ...
  velkoobchod: {
    ...
    subheading: 'Katalog 15 000+ produktů 65+ světových značek. Aktuální ceny a zásoby v reálném čase. Pro firmy s IČO.',
  ...
  feed: {
    ...
    subheading: 'Automatický XML/CSV feed 15 000+ prémiových produktů. Heureka, Zboží.cz, Google Shopping, Shoptet — synchronizované bez práce z vaší strany.',
  ...
  shop: {
    ...
    subheading: 'Zapomeňte na měsíce vývoje a hledání dodavatelů. Dostanete kompletní e-shop naplněný 15 000+ produkty — připravený k prodeji ihned.',
    bullets: ['E-shop setup na Shoptet, WooCommerce nebo Upgates', '15 000+ produktů importovaných hned od začátku', 'Automatická synchronizace cen a zásob přes feed', 'Volba: dropshipping (bez skladu) nebo vlastní sklad', 'Spuštění do 48 hodin, žádné zkušenosti nepotřebujete'],
...
const sk: GatewayText = {
  ...
  velkoobchod: { badge: 'B2B Veľkoobchod', label: 'Veľkoobchod',
    ...
    subheading: 'Katalóg 15 000+ produktov 65+ svetových značiek. Aktuálne ceny a zásoby v reálnom čase. Pre firmy s IČO.',
  ...
  feed: { badge: 'Novinka', label: 'swelt.feed',
    ...
    subheading: 'Automatický XML/CSV feed 15 000+ prémiových produktov. Heureka, Zbozi.cz, Google Shopping, Shoptet — synchronizované bez vašej práce.',
  ...
  shop: { badge: 'swelt.shop', label: 'swelt.shop',
    ...
    subheading: 'Zabudnite na mesiace vývoja a hľadania dodávateľov. Dostanete kompletný e-shop naplnený 15 000+ produktmi — pripravený na predaj ihneď.',
    bullets: ['E-shop setup na Shoptet, WooCommerce alebo Upgates', '15 000+ produktov importovaných od začiatku', 'Automatická synchronizácia cien a zásob cez feed', 'Voľba: dropshipping (bez skladu) alebo vlastný sklad', 'Spustenie do 48 hodín, žiadne skúsenosti netreba'],
...
const en: GatewayText = {
  ...
  velkoobchod: { badge: 'B2B Wholesale', label: 'Wholesale',
    ...
    subheading: 'Catalog of 15,000+ products from 65+ world brands. Real-time prices and stock. For companies with VAT ID.',
  ...
  feed: { badge: 'New product', label: 'swelt.feed',
    ...
    subheading: 'Automatic XML/CSV feed of 15,000+ premium products. Heureka, Zbozi.cz, Google Shopping, Shoptet — synchronized hands-free.',
  ...
  shop: { badge: 'swelt.shop', label: 'swelt.shop',
    ...
    subheading: 'Skip months of development and supplier hunting. Get a complete e-shop preloaded with 15,000+ products — ready to sell.',
    bullets: ['Shop setup on Shoptet, WooCommerce or Upgates', '15,000+ products imported from day one', 'Automatic price and stock sync via feed', 'Choice: dropshipping (no stock) or own stock', 'Live within 48 hours — no experience required'],
...
const de: GatewayText = {
  ...
  velkoobchod: { badge: 'B2B-Großhandel', label: 'Großhandel',
    ...
    subheading: 'Katalog mit 15.000+ Produkten von 65+ Weltmarken. Echtzeitpreise und -bestände. Für Unternehmen mit USt-ID.',
  ...
  feed: { badge: 'Neu', label: 'swelt.feed',
    ...
    subheading: 'Automatischer XML/CSV-Feed mit 15.000+ Premium-Produkten. Heureka, Zbozi.cz, Google Shopping, Shoptet — vollautomatisch synchronisiert.',
  ...
  shop: { badge: 'swelt.shop', label: 'swelt.shop',
    ...
    subheading: 'Sparen Sie sich Monate Entwicklung und Lieferantensuche. Sie erhalten einen kompletten Shop mit 15.000+ Produkten — sofort verkaufsbereit.',
    bullets: ['Shop-Setup auf Shoptet, WooCommerce oder Upgates', '15.000+ Produkte vom ersten Tag importiert', 'Automatische Preis- und Bestandssynchronisierung', 'Wahl: Dropshipping (kein Lager) oder eigenes Lager', 'Live in 48 Stunden — keine Erfahrung nötig'],
