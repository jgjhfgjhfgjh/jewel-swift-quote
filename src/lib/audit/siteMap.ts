...
export const SITE_MAP: SiteCluster[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { id: 'admin-integrations', label: 'Integrace', route: '/admin/integrations', sourceFile: 'src/pages/admin/AdminIntegrations.tsx', copySource: 'inline', audience: ['admin'], sections: [inlineSection('admin-integrations', 'registry', 'Registr nástrojů & MCP')] },
      { id: 'admin-automations', label: 'Automatizace', route: '/admin/automations', sourceFile: 'src/pages/admin/AdminAutomations.tsx', copySource: 'inline', audience: ['admin'], sections: [inlineSection('admin-automations', 'hub', 'Stav front & spouštění')] },
      { id: 'admin-finance', label: 'Finance', route: '/admin/finance', sourceFile: 'src/pages/admin/AdminFinance.tsx', copySource: 'inline', audience: ['admin'], sections: [inlineSection('admin-finance', 'kpi', 'GMV, marže, top produkty')] },
      { id: 'admin-marketing', label: 'Marketing', route: '/admin/marketing', sourceFile: 'src/pages/admin/AdminMarketing.tsx', copySource: 'inline', audience: ['admin'], sections: [inlineSection('admin-marketing', 'campaigns', 'DEAL kampaně & zdroje dat')] },
