...
const cs: FeedText = {
  hero: {
    ...
    sub1Pre: 'Pořiďte si ', sub1Mid: 'swelt.feed', sub1Post: ' a my vám propojíme e-shop s naším katalogem 15 000+ prémiových hodinek a doplňků — žádné technické znalosti nejsou potřeba.',
    ...
    bullets: ['15 000+ produktů', '7 formátů exportu', 'Aktualizace každé 2 hodiny', 'Bez technických znalostí'],
  },
  ...
  catalog: {
    eyebrow: 'Co dostanete v katalogu', heading: '15 000+ produktů připravených k prodeji',
  ...
  plans: [
    ...
    },
    {
      ...
      features: ['3 feedů najednou', 'Celý katalog — 15 000+ produktů', 'Aktualizace 4× denně (každých 6 h)', 'XML + CSV + Heureka + Zbozi', 'Google Shopping + Facebook Catalog', 'Chat podpora', 'swelt.signal Lite (přehled trendů)'],
      missing: [],
    },
    {
...
const en: FeedText = {
  hero: {
    ...
    sub1Pre: 'Get ', sub1Mid: 'swelt.feed', sub1Post: ' and we will connect your shop to our catalog of 15,000+ premium watches and accessories — no technical skills needed.',
    ...
    bullets: ['15,000+ products', '7 export formats', 'Updates every 2 hours', 'No technical skills'],
  },
  ...
  catalog: {
    eyebrow: 'What you get in the catalog', heading: '15,000+ products ready to sell',
  ...
  plans: [
    ...
    },
    {
      ...
      features: ['3 feeds at once', 'Full catalog — 15,000+ products', '4× daily updates (every 6 h)', 'XML + CSV + Heureka + Zbozi', 'Google Shopping + Facebook Catalog', 'Chat support', 'swelt.signal Lite (trend overview)'],
      missing: [],
    },
    {
  ...
  faqs: [
    { q: 'What is swelt.feed and how does it help me?', a: 'swelt.feed is a service that automatically transfers our catalog of 15,000+ premium watches and jewelry to your shop. Pick a plan, we prepare the feed file with products, prices and availability — your shop reads it once or four times a day automatically. No manual copying, no stale prices.' },
